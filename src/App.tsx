...
export default function App() {
  ...
  const sectionTitles: Record<string, string> = {
    ...
    "sec-resources": "Section 5: Recursos Didácticos para Docentes"
  };
    ...
    <div className="min-h-screen bg-[#F5F7FA] text-gray-800 font-sans antialiased flex flex-col">
      ...
      <footer className="border-t border-gray-200 bg-white py-6 px-6 text-xs text-gray-600 mt-auto">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-center sm:text-left text-gray-500 text-[11px]">
            © 2026 Marco Institucional UNESCO (Consenso de Beijing) • Gemini AI Models
          </p>
